...
fontSmall = pygame.font.Font('Resource/Calibri Bold.TTF', 20)
fontTiny = pygame.font.Font('Resource/Calibri Bold.TTF', 15)
...
while True:
    ...
    if check: #and time_start:
        if time_left == 0 or end_turn or check_click_fold:
            check = False
            check_click_fold = False
            turn_bet = ""
            turn_raise = ""
